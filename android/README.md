...
```gradle
dependencies {
    implementation 'com.github.apiverve:datecalculator-api:1.1.12'
}
```
...
```java
import com.apiverve.datecalculator.DateCalculatorAPIClient;
import com.apiverve.datecalculator.APIResponse;
import com.apiverve.datecalculator.APIException;

// Initialize the client
DateCalculatorAPIClient client = new DateCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/datecalculator](https://docs.apiverve.com/ref/datecalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/datecalculator](https://docs.apiverve.com/ref/datecalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/datecalculator-api/issues)

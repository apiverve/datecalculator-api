...
{
    class DateCalculatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/datecalculator";

        /// <summary>
        /// Make a GET request to the Date Calculator API
        /// </summary>
        static async Task<JsonDocument> CallDateCalculatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;start&quot;] &#x3D; &quot;2022-01-01&quot;, [&quot;end&quot;] &#x3D; &quot;2024-08-31&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Date Calculator API...\n");

            var result = await CallDateCalculatorAPI();

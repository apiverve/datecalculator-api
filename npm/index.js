...
class datecalculatorWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/datecalculator');
        }
        ...
        this.validationRules = {"start":{"type":"string","required":true,"format":"date"},"end":{"type":"string","required":true,"format":"date"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/datecalculator`);
        }
    }
...
module.exports = datecalculatorWrapper;

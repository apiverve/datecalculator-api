...
namespace APIVerve\Datecalculator;
...
/**
 * Client for the Date Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/datecalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/datecalculator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DatecalculatorClient] {$message}\n";
        }
    }
}

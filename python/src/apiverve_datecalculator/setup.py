...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/datecalculator',
        'Source': 'https://github.com/apiverve/datecalculator-api',
        'Bug Tracker': 'https://github.com/apiverve/datecalculator-api/issues'
    },
    classifiers=[
